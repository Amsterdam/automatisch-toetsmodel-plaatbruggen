...
class BatchCalculationComponent:
    ...
    def view_batch_readiness(self, params: Parametrization, entity_id: int, **kwargs) -> TableResult:  # noqa: ARG002
        ...
        try:
            ...
            print(f"DEBUG [view_batch_readiness:63]: Retrieved type={type(batch_results_file)}, isinstance(bool)={isinstance(batch_results_file, bool)}, isinstance(File)={isinstance(batch_results_file, File)}, value={batch_results_file}")
    ...
    def run_batch_calculation(self, params: Parametrization, entity_id: int, **kwargs) -> None:  # noqa: ARG002
        ...
        try:
            ...
            try:
                ...
                # DEBUG: Detailed type information
                print(f"DEBUG [run_batch_calculation:214]: Retrieved type={type(batch_results_file)}, isinstance(bool)={isinstance(batch_results_file, bool)}, isinstance(File)={isinstance(batch_results_file, File)}, value={batch_results_file}")
    ...
    def view_batch_results(self, params: Parametrization, entity_id: int, **kwargs) -> TableResult:  # noqa: ARG002
        ...
        try:
            ...
            # DEBUG: Detailed type information
            print(f"DEBUG [view_batch_results:450]: Retrieved type={type(batch_results_file)}, isinstance(bool)={isinstance(batch_results_file, bool)}, isinstance(File)={isinstance(batch_results_file, File)}, value={batch_results_file}")
        ...
        if should_trigger_calculation:
            ...
            try:
                ...
                try:
                    ...
                    print(f"DEBUG [view_batch_results:573]: Exception caught from run_batch_calculation: {type(calc_error).__name__}: {calc_error}", flush=True)
                    import traceback
                ...
                try:
                    ...
                    # DEBUG: Detailed type information
                    print(f"DEBUG [view_batch_results:565]: Retrieved type={type(batch_results_file)}, isinstance(bool)={isinstance(batch_results_file, bool)}, isinstance(File)={isinstance(batch_results_file, File)}, value={batch_results_file}")
