...
class TestSCIAInterfaceCoreFunctions:
    ...
    def test_thickness_data_creation(self) -> None:
        ...
        expected = {
            "Z1_1": 2.1, "Z2_1": 3.1, "Z3_1": 2.1,  # From segment 1
            "Z1_2": 2.2, "Z2_2": 3.2, "Z3_2": 2.2,  # From segment 2
        }
...
class TestSCIAWorkflowLogic:
    ...
    def test_en_1990_load_factors(self) -> None:
        ...
        uls_total = (uls_factors["permanent_unfavorable"] * dead_load + 
        ...
        sls_char_total = (sls_factors["permanent"] * dead_load + 
                          sls_factors["variable_characteristic"] * live_load_1 + 
                          0.6 * live_load_2)
