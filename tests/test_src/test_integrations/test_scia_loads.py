...
class TestAccidentalVehicleLoads:
    ...
    def test_add_accidental_vehicle_loads_direction_logic(self, mock_builder: Mock, mock_params: Mock) -> None:
        ...
        with (
            ...
            mock_sequencer.return_value = [10.0]  # Single position for normal vehicle
            mock_sequencer_single.return_value = [15.0]  # Single position for Amsterdam vehicle
            ...
            # Amsterdam vehicle: single heavy axle at position
            ...
            # Verify Amsterdam vehicle properties
            assert amsterdam_rs1.kwargs["corner_points"][1][0] - amsterdam_rs1.kwargs["corner_points"][0][0] == 0.4  # 0.4m wheel contact area
            assert abs(amsterdam_rs1.kwargs["load_value"]) == 240000 / (2 * 0.4 * 0.4)  # 240 kN total, divided by 2 wheels and contact area
            assert amsterdam_rs3.kwargs["corner_points"][1][0] - amsterdam_rs3.kwargs["corner_points"][0][0] == 0.4  # Same for RS3
    ...
    def test_add_accidental_vehicle_loads_single_axis_positions(self, mock_builder: Mock, mock_params: Mock) -> None:
        ...
        with (
            ...
            mock_sequencer.return_value = [2.0, 5.0, 8.0]  # Normal vehicle positions
            mock_sequencer_single.return_value = [2.0, 4.0, 6.0, 8.0]  # More frequent positions for Amsterdam vehicle
