...
class TestLoadBoundaryCompliance:
    ...
    def test_dispersal_function_with_real_bridge_data(self, bridge_default_params: Munch) -> None:
        ...
        def mock_dispersal_function(params, corner_points, load_value, load_case_type):
        ...
        dispersed_coords, dispersed_load = mock_dispersal_function(
            params=bridge_default_params,
        ...
        test_cases = [
            {
                ...
                "length": 10.0,
                "width": 30.0,
                "test_coords": [(-1.0, 16.0, 0.0), (11.0, -16.0, 0.0)]
            },
            {
                "name": "Complex Bridge", 
                "length": 25.0,
                "width": 40.0,
                "test_coords": [(-2.0, 21.0, 0.0), (27.0, -21.0, 0.0)]
            }
        ]
