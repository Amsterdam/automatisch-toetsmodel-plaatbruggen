...
class TestViktorIdeaModelBuilder:
    ...
    @patch("app.bridge.idea_model_builder.idea_rcs")
    def test_create_concrete_material_modern(self, mock_idea_rcs: MagicMock, builder: ViktorIdeaModelBuilder) -> None:
    ...
    @patch("app.bridge.idea_model_builder.idea_rcs")
    def test_create_reinforcement_material_modern(self, mock_idea_rcs: MagicMock, builder: ViktorIdeaModelBuilder) -> None:
    ...
    @patch("app.bridge.idea_model_builder.idea_rcs")
    def test_create_one_way_slab(self, mock_idea_rcs: MagicMock, builder: ViktorIdeaModelBuilder) -> None:
    ...
    @patch("app.bridge.idea_model_builder.idea_rcs")
    def test_create_bar_on_slab(self, mock_idea_rcs: MagicMock, builder: ViktorIdeaModelBuilder) -> None:
    ...
    @patch("app.bridge.idea_model_builder.idea_rcs")
    def test_create_extreme_on_slab(self, mock_idea_rcs: MagicMock, builder: ViktorIdeaModelBuilder) -> None:
    ...
    @patch("app.bridge.idea_model_builder.idea_rcs")
    def test_generate_xml_input(self, mock_idea_rcs: MagicMock, builder: ViktorIdeaModelBuilder) -> None:
