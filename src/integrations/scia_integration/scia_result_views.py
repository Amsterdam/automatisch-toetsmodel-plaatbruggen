...
from src.integrations.idea_integration.scia_to_idea_functions import process_scia_results_for_idea, process_scia_1d_results_for_idea
...
def create_scia_1d_result_table(results: dict[str, Any], result_type: str) -> TableResult:
    ...
    try:
        ...
        error_message = f"Error processing 1D results: {str(e)}"
        return TableResult(
