"""
SCIA utility functions.

This module provides utility functions for checking the availability of the VIKTOR SCIA module and defining type aliases for SCIA-related objects.
"""
